...
export type ConfigNames = 'fans/ignores' | 'fans/ignores/git' | 'fans/javascript' | 'fans/imports' | 'fans/promise' | 'fans/node' | 'fans/de-morgan' | 'fans/unicorn' | 'fans/unicorn/vue' | 'fans/unicorn/astro' | 'fans/unicorn/storybook' | 'fans/unicorn/testing' | 'fans/typescript' | 'fans/typescript/testing' | 'fans/vue' | 'fans/astro' | 'fans/astro/pages' | 'fans/prettier' | 'fans/stylistic' | 'fans/perfectionist' | 'fans/oxlint/from-oxlint-config' | 'fans/oxlint/vue-svelte-exceptions' | 'fans/oxlint/from-oxlint-config-override-0' | 'fans/oxlint/from-oxlint-config-override-1' | 'fans/oxlint/from-oxlint-config-override-2' | 'fans/oxlint/from-oxlint-config-override-3' | 'fans/oxlint/from-oxlint-config-override-4' | 'fans/oxlint/from-oxlint-config-override-5' | 'fans/oxlint/from-oxlint-config-override-6' | 'fans/oxlint/from-oxlint-config-override-7' | 'fans/oxlint/from-oxlint-config-override-8'
